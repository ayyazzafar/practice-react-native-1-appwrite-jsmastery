        ...
        <View className="mt-7 space-y-2">
          ...
          <TouchableOpacity onPress={() => openPicker("video")}>
            {form.video ? (
              ...
              <View className="h-ful h-40 px-4 bg-black-100 rounded-2xl justify-center items-center">
        ...
        <View className="mt-7 space-y-2">
          ...
          <TouchableOpacity className="" onPress={() => openPicker("image")}>
            {form.thumbnail ? (
              ...
              <View className="h-ful h-16 px-4 bg-black-100 rounded-2xl justify-center items-center border-2 border-black-200 flex-row space-x-2">
                <Image
                  source={icons.upload}
                  resizeMode="contain"
                  className="w-5 h-5"
